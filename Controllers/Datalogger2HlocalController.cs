...
namespace APIsolarMonitoring.Controllers
{
    ...
    public class Datalogger2HlocalController : ControllerBase
    {
        private const string CsvFilePath = FilesPaths.Dataloger2hLocal24;
        ...
        [HttpGet("Graph")]
        public ActionResult<IEnumerable<dynamic>> Graph([FromQuery] Datalogger2Filters filters)
        {
            var data = ReadCsvFile(filters);
            var jsonData = JsonConvert.SerializeObject(data);
            return Ok(jsonData);
